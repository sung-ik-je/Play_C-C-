...
const ::uint32_t
    TableStruct_test_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::grpc_tutorial_cpp::HelloRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::grpc_tutorial_cpp::HelloRequest, _impl_.name_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::grpc_tutorial_cpp::HelloReply, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::grpc_tutorial_cpp::HelloReply, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::grpc_tutorial_cpp::HelloRequest)},
        {9, -1, -1, sizeof(::grpc_tutorial_cpp::HelloReply)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::grpc_tutorial_cpp::_HelloRequest_default_instance_._instance,
    &::grpc_tutorial_cpp::_HelloReply_default_instance_._instance,
};
const char descriptor_table_protodef_test_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\ntest.proto\022\021grpc_tutorial_cpp\"\034\n\014Hello"
    "Request\022\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007m"
    "essage\030\001 \001(\t2U\n\007Greeter\022J\n\010SayHello\022\037.gr"
    "pc_tutorial_cpp.HelloRequest\032\035.grpc_tuto"
    "rial_cpp.HelloReplyb\006proto3"
};
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:grpc_tutorial_cpp.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::grpc_tutorial_cpp::HelloRequest& from_msg)
...
HelloRequest::HelloRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:grpc_tutorial_cpp.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:grpc_tutorial_cpp.HelloRequest)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 43, 2> HelloRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::grpc_tutorial_cpp::HelloRequest>(),  // to_prefetch
  ...
  {{
    "\36\4\0\0\0\0\0\0"
    "grpc_tutorial_cpp.HelloRequest"
    "name"
  }},
};

PROTOBUF_NOINLINE void HelloRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:grpc_tutorial_cpp.HelloRequest)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:grpc_tutorial_cpp.HelloRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_name().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "grpc_tutorial_cpp.HelloRequest.name");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:grpc_tutorial_cpp.HelloRequest)
          return target;
        }
        ...
        ::size_t HelloRequest::ByteSizeLong() const {
          const HelloRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:grpc_tutorial_cpp.HelloRequest)
          ::size_t total_size = 0;
...
void HelloRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:grpc_tutorial_cpp.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:grpc_tutorial_cpp.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:grpc_tutorial_cpp.HelloReply)
}
inline PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::grpc_tutorial_cpp::HelloReply& from_msg)
...
HelloReply::HelloReply(
  ...
  // @@protoc_insertion_point(copy_constructor:grpc_tutorial_cpp.HelloReply)
}
inline PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
HelloReply::~HelloReply() {
  // @@protoc_insertion_point(destructor:grpc_tutorial_cpp.HelloReply)
  SharedDtor(*this);
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 44, 2> HelloReply::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    1, 0,  // max_field_number, fast_idx_mask
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::grpc_tutorial_cpp::HelloReply>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string message = 1;
    {::_pbi::TcParser::FastUS1,
  ...
  {{
    "\34\7\0\0\0\0\0\0"
    "grpc_tutorial_cpp.HelloReply"
    "message"
  }},
};

PROTOBUF_NOINLINE void HelloReply::Clear() {
// @@protoc_insertion_point(message_clear_start:grpc_tutorial_cpp.HelloReply)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloReply::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:grpc_tutorial_cpp.HelloReply)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "grpc_tutorial_cpp.HelloReply.message");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
          ...
          // @@protoc_insertion_point(serialize_to_array_end:grpc_tutorial_cpp.HelloReply)
          return target;
        }
        ...
        ::size_t HelloReply::ByteSizeLong() const {
          const HelloReply& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:grpc_tutorial_cpp.HelloReply)
          ::size_t total_size = 0;
...
void HelloReply::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:grpc_tutorial_cpp.HelloReply)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:grpc_tutorial_cpp.HelloReply)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
